...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/AI1411/m_app/gen/grpc/user/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	UserServiceName = "grpc.user.v1.UserService"
)
...
const (
	...
	UserServiceGetUserProcedure = "/grpc.user.v1.UserService/GetUser"
	// UserServiceSearchUsersProcedure is the fully-qualified name of the UserService's SearchUsers RPC.
	UserServiceSearchUsersProcedure = "/grpc.user.v1.UserService/SearchUsers"
	// UserServiceCreateUserProcedure is the fully-qualified name of the UserService's CreateUser RPC.
	UserServiceCreateUserProcedure = "/grpc.user.v1.UserService/CreateUser"
	// UserServiceUpdateUserProcedure is the fully-qualified name of the UserService's UpdateUser RPC.
	UserServiceUpdateUserProcedure = "/grpc.user.v1.UserService/UpdateUser"
)

// UserServiceClient is a client for the grpc.user.v1.UserService service.
...
// NewUserServiceClient constructs a client for the grpc.user.v1.UserService service. By default, it
...
func NewUserServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) UserServiceClient {
	...
	userServiceMethods := v1.File_grpc_user_v1_user_proto.Services().ByName("UserService").Methods()
...
// GetUser calls grpc.user.v1.UserService.GetUser.
...
// SearchUsers calls grpc.user.v1.UserService.SearchUsers.
...
// CreateUser calls grpc.user.v1.UserService.CreateUser.
...
// UpdateUser calls grpc.user.v1.UserService.UpdateUser.
...
// UserServiceHandler is an implementation of the grpc.user.v1.UserService service.
...
func NewUserServiceHandler(svc UserServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/grpc.user.v1.UserService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedUserServiceHandler) GetUser(context.Context, *connect.Request[v1.GetUserRequest]) (*connect.Response[v1.GetUserResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("grpc.user.v1.UserService.GetUser is not implemented"))
}
...
func (UnimplementedUserServiceHandler) SearchUsers(context.Context, *connect.Request[v1.SearchUsersRequest]) (*connect.Response[v1.SearchUsersResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("grpc.user.v1.UserService.SearchUsers is not implemented"))
}
...
func (UnimplementedUserServiceHandler) CreateUser(context.Context, *connect.Request[v1.CreateUserRequest]) (*connect.Response[v1.CreateUserResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("grpc.user.v1.UserService.CreateUser is not implemented"))
}
...
func (UnimplementedUserServiceHandler) UpdateUser(context.Context, *connect.Request[v1.UpdateUserRequest]) (*connect.Response[v1.UpdateUserResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("grpc.user.v1.UserService.UpdateUser is not implemented"))
}
